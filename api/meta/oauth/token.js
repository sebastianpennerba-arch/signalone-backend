...
//
// Antwort:
//   200: { accessToken, expiresIn, tokenType, adAccounts: [...] }
//   4xx/5xx: { error: "..." }
    ...
    try {
        ...
        if (!appId || !appSecret || !configuredRedirectUri) {
            return res.status(500).json({
                error: "Server misconfigured. META_APP_ID, META_APP_SECRET oder META_OAUTH_REDIRECT_URI fehlen."
            });
        }
        ...
        try {
            ...
            adAccountUrl.searchParams.set("fields", "id,account_id,name,account_status,timezone_name,currency");
